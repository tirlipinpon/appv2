...
import { APP_VERSION_TOKEN } from '../../tokens/app-version.token';
...
export class AppHeaderComponent implements OnInit, OnDestroy {
  ...
  private readonly appVersion = inject(APP_VERSION_TOKEN);
  ...
  // Les profils parent et teacher seront injectés depuis admin si nécessaire
  readonly parentProfile = computed(() => null);
  readonly teacherProfile = computed(() => null);
  ...
  readonly appVersionDisplay = computed(() => {
  ...
  readonly displayName = computed(() => {
    ...
    // Note: Les profils parent et teacher doivent être injectés depuis admin
    // Pour l'instant, on utilise display_name par défaut
